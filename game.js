...
(function() {
  ...
  function initGame() {
    ...
    console.log('CANCER_NAMES:', CANCER_NAMES); // Debug
    console.log('Total cancers:', CANCER_NAMES.length); // Debug
    ...
    console.log('mutations-container:', mutationsContainer);
    ...
    function init() {
      ...
      console.log('Data for answer:', CANCER_DATA[currentCancer]); // Debug
    ...
    function renderProfile() {
      ...
      console.log('Rendering profile for:', currentCancer); // Debug
      console.log('Profile data:', data); // Debug
      
      if (!data) {
        console.error('No data found for:', currentCancer);
        return;
      }
      ...
      if (data.mutations && data.mutations.length > 0) {
        data.mutations.forEach(m => {
          console.log('Adding mutation:', m.gene, m.frequency); // Debug
      ...
      if (data.cnv && data.cnv.amplifications) {
      ...
      if (data.cnv && data.cnv.deletions) {
      ...
      if (data.histology && data.histology.url) {
        ...
        histologyImg.style.display = 'block';
      } else {
        histologyImg.src = '';
        histologyImg.style.display = 'none';
      }
